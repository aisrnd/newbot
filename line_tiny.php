...
class LINEBotTiny
{
	...
	public function pushMessage($message2send, $dest_ids)
	{
		$httpClient = new Git\LINEBot\HTTPClient\CurlHTTPClient($this->channelAccessToken);
		$bot = new Git\LINEBot($httpClient, ['channelSecret' => $this->channelSecret]);

		//$allMember_Ids= $bit->getAllGroupMemberIds
